      ...
      <Card className="animate-in w-full max-w-md overflow-hidden rounded-2xl border-none shadow-xl shadow-indigo-100 fade-in slide-in-from-bottom-4 duration-500 sm:rounded-3xl sm:shadow-2xl">
        ...
        <CardContent className="p-4 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    required
                    className="w-full h-11 pl-10 pr-4 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all disabled:bg-slate-50 disabled:text-slate-500 font-medium italic"
                  />
                </div>
                ...
                {isEmailVerified && (
                  <div className="flex items-center gap-1.5 text-green-600 font-black italic text-[10px] uppercase bg-green-50 px-3 rounded-xl border border-green-100">
            ...
            {otpSent && !isEmailVerified && (
              <div className="space-y-4 animate-in slide-in-from-top-4 duration-500">
                <div className="space-y-1.5">
                  ...
                  <p className="text-[10px] text-slate-400 font-bold italic ml-1">Code expires in 5 minutes. No code? <button type="button" onClick={handleSendOtp} className="text-indigo-600 underline">Resend</button></p>
                </div>
              </div>
            )}
            ...
            <Button 
              type="submit" 
              className="w-full h-12 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white font-black uppercase tracking-[0.2em] italic shadow-xl shadow-slate-200 transition-all active:scale-95 disabled:opacity-50" 
