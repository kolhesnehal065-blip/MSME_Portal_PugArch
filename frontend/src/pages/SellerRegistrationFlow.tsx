...
export default function SellerRegistrationFlow() {
  ...
  return (
    <div className="min-h-dvh bg-white px-3 py-4 sm:px-4 md:py-6">
      <div className="mx-auto flex max-w-7xl flex-col">
        <div className="mb-4 flex shrink-0 justify-center md:mb-6">
          <div className="no-scrollbar flex w-full max-w-[1500px] items-center justify-start gap-3 overflow-x-auto rounded-xl bg-[#f5f5f5] px-3 py-2.5 sm:justify-center sm:gap-5 sm:px-6 sm:py-3 md:gap-8">
